...
public class PZ_Puzzle_Item : PZ_Interact_Spawn
{
    ...
    private PZ_Puzzle_UI_Base _popupPuzzle; // 퍼즐
    ...
    public override void Interact(GameObject player)
    {
        ...
        Managers.UI.ShowPopupUI<PZ_Puzzle_UI_Base>(_puzzleAddressable, null, (popupPuzzle) =>
        {
            _popupPuzzle = popupPuzzle;
            _popupPuzzle.SetPuzzleOwner(this);
        });
    }
